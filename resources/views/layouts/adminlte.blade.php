            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column">
                    @auth
                        ...
                        @if(auth()->user()->isProductor())
                            <li class="nav-header">MI PREDIO</li>
                            <li class="nav-item">
                                <a href="{{ route('perfil.ubicacion') }}" class="nav-link {{ request()->routeIs('perfil.ubicacion*') ? 'active' : '' }}">
                            ...
                            @if(!auth()->user()->estaVerificado())
                                <li class="nav-item">
                                    <a href="{{ route('verificacion.create') }}" class="nav-link {{ request()->routeIs('verificacion*') ? 'active' : '' }}">
                        ...
                        <li class="nav-item mt-3">
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button type="submit" class="nav-link text-left" style="background:none;border:none;color:#cfe6d0;">
