            ...
            <form action="{{ route('productos.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="number" step="0.01" name="cantidad_disponible" class="form-control"
                        value="{{ old('cantidad_disponible') }}" placeholder="Ej. 10">
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <select name="unidad_medida" class="form-control">
                        ...
                        <option value="tonelada" {{ old('unidad_medida') == 'tonelada' ? 'selected' : '' }}>Tonelada
                        </option>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="date" name="fecha_disponibilidad" class="form-control"
                        value="{{ old('fecha_disponibilidad') }}" min="{{ date('Y-m-d') }}">

                    <small class="text-muted">
                        Si la fecha es futura, el producto se publicará como preventa.
                    </small>
                </div>
