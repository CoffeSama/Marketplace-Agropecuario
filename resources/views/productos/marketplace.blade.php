                        ...
                        <div id="ubicacion-estado" class="small mb-1">
                            @if (request('lat') && request('lng'))
                                <span class="text-success">
                                    <i class="fas fa-check-circle mr-1"></i> Detectada
                                </span>
                            @else
                                <span class="text-muted">
                                    <i class="fas fa-info-circle mr-1"></i> Sin ubicación
                                </span>
                            @endif
                        </div>
...
<div class="row">
    @forelse($productos as $producto)
        @php
            $requiereEntero = in_array($producto->unidad_medida, ['unidad', 'caja', 'saco']);
            $stepCantidad = $requiereEntero ? '1' : '0.01';
            $minCantidad = $requiereEntero ? '1' : '0.01';
        @endphp
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-1">
                        ...
                        Bs {{ number_format($producto->precio, 2) }} / {{ $producto->unidad_medida }}
                    </p>
                ...
                <div class="card-footer bg-white py-2">
                    <small class="text-muted d-block">
                        ...
                        {{ $producto->productor->name ?? '—' }}
                    </small>

                    @php
                        $ubicacion = $producto->productor->productor->ubicacion_administrativa ?? null;
                    @endphp
