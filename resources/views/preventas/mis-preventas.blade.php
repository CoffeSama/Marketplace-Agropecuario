        ...
        <div class="card-body">
            @forelse($preventas as $preventa)
                <div class="border rounded p-3 mb-3">
                    ...
                    <p><strong>Anticipo pagado 40%:</strong> Bs {{ number_format($preventa->anticipo, 2) }}</p>
                    ...
                    @if (
                        ...
                        <form action="{{ route('preventas.completar-pago', $preventa) }}" method="POST">
                            @csrf
                            <button class="btn btn-success">
                                Completar pago del saldo
                            </button>
                        </form>
